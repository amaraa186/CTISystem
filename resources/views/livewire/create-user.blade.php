    ...
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="form">
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <x-jet-input id="kana" type="text" class="mt-1 block w-full form-control shadow-none" wire:model.defer="user.kana" />
                <x-jet-input-error for="user.kana" class="mt-2" />
            </div>
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="password_confirmation" value="{{ __('パスワードを認証して') }}" />
